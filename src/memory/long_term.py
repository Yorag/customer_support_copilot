...
class CustomerMemoryService:
    ...
    def collect_case_context(
        ...
        *,
        ...
        return {
            ...
            "customer_profile": self._serialize_profile(profile),
            "state_memory_updates": dict(state_payload.get("memory_updates") or {}),
            "human_handoff_summary": state_payload.get("human_handoff_summary"),
            "thread_summary": state_payload.get("thread_summary"),
    ...
    def validate_memory_updates(
        ...
        risk_tags = sorted({tag for tag in updates.risk_tags_to_add if tag})
        payload = {
    ...
    def _serialize_profile(
        self,
        profile: CustomerMemoryProfile | None,
    ) -> dict[str, Any] | None:
        if profile is None:
            return None
        return {
