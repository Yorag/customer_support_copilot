...
class Nodes:
    def __init__(self, agents=None, service_container=None):
        if agents is None:
    ...
    def create_draft_response(self, state: GraphState) -> GraphState:
        ...
        self.gmail_client.create_draft_reply(
            state["current_email"],
    ...
    def send_email_response(self, state: GraphState) -> GraphState:
        ...
        self.gmail_client.send_reply(state["current_email"], state["generated_email"])
